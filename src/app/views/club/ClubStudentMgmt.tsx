            ...
            if (filteredPending.length === 0) {
                return (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h3 className="text-lg font-bold text-gray-700 mb-1">No pending applications</h3>
                        <p className="text-sm text-gray-400 max-w-xs">New student requests will appear here when they apply to join your club.</p>
                    </div>
                );
            }
        ...
        if (filteredMembers.length === 0) {
            return (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-700 mb-1">No members yet</h3>
                    <p className="text-sm text-gray-400 max-w-xs">Approve student applications to start building your club roster.</p>
                </div>
            );
        }
